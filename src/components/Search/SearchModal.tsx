              ...
              <>
                ...
                {results.slice(0, 8).map(product => (
                  <div
                    ...
                    className="p-3 rounded-2xl bg-white hover:bg-gray-50 border border-gray-100 hover:border-gray-300 cursor-pointer transition flex items-center gap-4 group"
                  >
                    ...
                    <div className="text-right shrink-0">
                      <span className="text-sm font-black text-black block">
                        {product.price > 0 ? `${product.price} ${siteConfig.currency}` : 'Sur demande'}
                      </span>
