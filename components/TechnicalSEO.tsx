...
const TechnicalSEO: React.FC = () => {
  const [trend, setTrend] = useState<{ title: string; content: string; date: string } | null>(null);

  useEffect(() => {
    // Dynamically import the SEO trend generated by the Auto-Pilot
    import('../src/data/seo_trends.json')
      .then((data) => setTrend(data.default || data))
      .catch((err) => console.error('No SEO trend found yet', err));
  }, []);
