...
const Products: React.FC<ProductsProps> = ({
  ...
  // Calculate max price from products with a safe fallback
  ...
  const filteredProducts = useMemo(() => {
    ...
    // If there are no products at all, skip further filtering
  ...
  // Base empty state: no products at all
  if (products.length === 0) {
    const phone = siteConfig.phone.replace('+212', '212');
    const msg = "Bonjour, je souhaite plus d'informations sur vos produits d'éclairage.";
        ...
        <div className="container mx-auto px-4 md:px-6">
          ...
          <div className="text-center py-16">
            ...
            <p className="text-gray-500 mb-6 max-w-md mx-auto">
              Nous mettons à jour notre catalogue. Contactez-nous sur WhatsApp pour obtenir des recommandations ou un devis personnalisé.
            </p>
            <a
