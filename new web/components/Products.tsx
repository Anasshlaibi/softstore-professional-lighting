...
const Products: React.FC<ProductsProps> = ({
  ...
  return (
    <section id="collection" className="py-12 md:py-20 bg-white dark:bg-zinc-950">
      <div className="container mx-auto px-4 md:px-6">
        {/* Header */}
        <div className="text-center mb-8 md:mb-12">
          <h2 className="text-2xl md:text-4xl font-bold text-black dark:text-white mb-2 md:mb-4">
            Notre Collection.
          </h2>
