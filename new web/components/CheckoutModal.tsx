...
const CheckoutModal: React.FC<CheckoutModalProps> = ({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      await supabase.from('orders gearshop').insert([{
        id: `GS-${commandId}`,
    ...
    const existingOrders = JSON.parse(localStorage.getItem('gearshop_orders') || '[]');
    localStorage.setItem('gearshop_orders', JSON.stringify([localOrder, ...existingOrders]));
