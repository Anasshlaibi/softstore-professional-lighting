        ...
        <details className="group">
          ...
          <div className="mt-6 text-[13px] text-gray-500 leading-relaxed max-w-4xl animate-fade-in space-y-6">
            <div className="prose prose-sm prose-gray">
              ...
              <p>
                Utiliser une <a href="#collection" className="text-black font-bold underline">Softbox ZSYB Casablanca</a> permet de transformer une source de lumière ponctuelle et dure en une nappe de lumière douce et enveloppante. C'est l'accessoire indispensable pour le portrait ou les interviews YouTube. Nos boîtes à lumière sont conçues avec des matériaux réfléchissants haute performance et des diffuseurs doubles couches pour éliminer les points chauds. Que vous travailliez dans un petit studio ou sur un grand plateau à <strong>Casablanca</strong>, la modularité des montures Bowens de nos Softbox permet une compatibilité totale avec toute notre gamme de projecteurs.
              </p>
              ...
              <p>
                Le marché du <strong>matériel studio photo Rabat</strong> exige notament de la performance, mais aussi une fiabilité à long terme. C'est pourquoi GearShop.ma s'engage sur le <strong>meilleur prix éclairage vidéo</strong> tout en offrant une garantie locale. Nous comprenons les besoins des photographes de mariage et des agences de communication qui ne peuvent se permettre une panne en plein shooting. Notre stock inclut également des références prestigieuses comme le <strong>Canon R6 Mark II stock</strong>, permettant une synergie parfaite entre votre capteur et votre éclairage.
              </p>

              <h3 className="text-gray-800 font-bold text-base mt-6 mb-3">Vente matériel audiovisuel Casablanca : Pourquoi nous faire confiance ?</h3>
              <p>
                La <strong>vente matériel audiovisuel à Casablanca</strong> s'est développée autour d'une exigence : la précision technique. Nos produits supportent les modes Bi-color (ajustables de 2700K à 6500K) permettant de matcher la lumière naturelle du jour ou l'ambiance chaleureuse des intérieurs marocains. Chaque kit vendu subit des tests rigoureux de stabilité de tension pour s'adapter parfaitement aux réseaux électriques locaux. En choisissant GearShop, vous investissez dans du matériel durable, évolutif et soutenu par une expertise technique locale passionnée par l'image. Nous assurons une livraison rapide dans tout le Maroc.
              </p>
